...
<section class="home" id="home">
    ...
    <div class="content">
        <h3>Track your progress improve your health</h3>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem sed autem vero? Magnam, est laboriosam!</p>
        <a href="#book" class="btn"> Sign up <span class="fas fa-chevron-right"></span> </a>
    </div>
...
<!--<section class="Account" id="Account"></section>
<div class="container">
        ...
        <div class="form-container">
            ...
            <form id="login-form">
                ...
                <div class="checkbox"><label for="check" >
                    <input type="checkbox" name="check" id="check" > <p> Remember Me </p>
                </label></div>
...
<section class="footer">
    ...
    <div class="credit"> created by <span>Team medicos</span> | all rights reserved </div>
...
</html><?php /**PATH D:\Medox\Medox\resources\views/welcome.blade.php ENDPATH**/ ?>